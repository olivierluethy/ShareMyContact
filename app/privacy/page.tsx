    ...
    <main className="min-h-screen bg-gray-950 text-gray-300 py-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-16 border-b border-white/10 pb-8 text-center sm:text-left">
          <div className="flex justify-center sm:justify-start items-center gap-3 mb-4 text-emerald-400">
            <ShieldCheck className="w-8 h-8" />
            <span className="font-mono text-sm tracking-widest uppercase">Privacy Commitment</span>
          </div>
        ...
        <div className="mb-16 p-8 rounded-3xl bg-gradient-to-br from-emerald-500/10 to-indigo-500/5 border border-emerald-500/20 shadow-2xl">
          <div className="flex items-start gap-4">
            <EyeOff className="w-8 h-8 text-emerald-400 shrink-0 mt-1" />
            <div>
              <h2 className="text-xl font-bold text-white mb-2">Zero-Knowledge Architecture</h2>
        ...
        <div className="space-y-12">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-3 text-white">
              ...
              <h2 className="text-2xl font-bold">2. Security & Hosting</h2>
            </div>
            <p className="leading-relaxed">
          ...
          {/* Contact Link */}
          <section className="pt-8 border-t border-white/10 text-center sm:text-left">
